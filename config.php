...
define('SMTP_USERNAME', 'johann@toris.co.za'); // Use an email from your domain
define('SMTP_PASSWORD', 'your_password'); // Email password

// Sender details (MUST be from the website's domain)
define('EMAIL_FROM', 'johann@toris.co.za'); 
define('EMAIL_FROM_NAME', 'Therapy Website Contact');

// Recipient details (Must be the website email as well)
define('EMAIL_TO', 'johanncareer@gmail.com');
